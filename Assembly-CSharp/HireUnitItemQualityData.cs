...
public class HireUnitItemQualityData : DataCore
{
	public int Id
	{
		get;
	...
	public static HireUnitItemQualityData GetRandomRatio(List<HireUnitItemQualityData> datas, Tyche tyche, Dictionary<int, int> modifiers = null)
	{
		int num = 0;
