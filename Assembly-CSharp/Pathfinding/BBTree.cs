...
namespace Pathfinding
{
    public class BBTree : IAstarPooledObject
    {
        ...
        private void EnsureCapacity(int c)
        {
            if (arr.Length < c)
            {
                BBTreeBox[] array = new BBTreeBox[Math.Max(c, (int)((float)arr.Length * 2f))];
        ...
        public void RebuildFrom(MeshNode[] nodes)
        {
            ...
            RebuildFromInternal(array, 0, nodes.Length, odd: false);
        }
        ...
        public NNInfoInternal Query(Vector3 p, NNConstraint constraint)
        {
            ...
            NNInfoInternal nnInfo = default(NNInfoInternal);
