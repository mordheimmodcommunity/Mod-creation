		...
		public void GetContour(List<List<IntPoint>> buffer)
		{
			...
			case MeshType.Circle:
			{
				...
				if (useRotation)
				{
					...
					{
						list.Add(V3ToIntPoint(matrix.MultiplyPoint3x4(center + new Vector3(Mathf.Cos((float)(l * 2) * MathF.PI / (float)circleResolution), 0f, Mathf.Sin((float)(l * 2) * MathF.PI / (float)circleResolution)) * circleRadius)));
					}
				}
				else
				{
					...
					{
						list.Add(V3ToIntPoint(position + new Vector3(Mathf.Cos((float)(m * 2) * MathF.PI / (float)circleResolution), 0f, Mathf.Sin((float)(m * 2) * MathF.PI / (float)circleResolution)) * circleRadius));
					}
				}
				if (flag)
				{
