...
public class HireUnitItemData : DataCore
{
    public int Id
    {
        get;
    ...
    public static HireUnitItemData GetRandomRatio(List<HireUnitItemData> datas, Tyche tyche, Dictionary<int, int> modifiers = null)
    {
        int num = 0;
