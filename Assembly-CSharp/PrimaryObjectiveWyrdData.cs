...
public class PrimaryObjectiveWyrdData : DataCore
{
    public int Id
    {
        get;
    ...
    public override void Populate(SqliteDataReader reader)
    {
        ...
        WyrdstonePerc = reader.GetInt32(3);
    }

    public static PrimaryObjectiveWyrdData GetRandomRatio(List<PrimaryObjectiveWyrdData> datas, Tyche tyche, Dictionary<int, int> modifiers = null)
    {
        int num = 0;
