...
public class MarketEventData : DataCore
{
    public MarketEventId Id
    {
        get;
        private set;
    }
    ...
    {
        Id = (MarketEventId)reader.GetInt32(0);
        Name = reader.GetString(1);
        WarbandSkillId = (WarbandSkillId)reader.GetInt32(2);
        Ratio = reader.GetInt32(3);
    }

    public static MarketEventData GetRandomRatio(List<MarketEventData> datas, Tyche tyche, Dictionary<MarketEventId, int> modifiers = null)
    {
        int num = 0;
