...
public class ProcMissionRatingSearchDensityData : DataCore
{
    public int Id
    {
        get;
    ...
    public override void Populate(SqliteDataReader reader)
    {
        ...
        SearchDensityId = (SearchDensityId)reader.GetInt32(2);
        Ratio = reader.GetInt32(3);
    }

    public static ProcMissionRatingSearchDensityData GetRandomRatio(List<ProcMissionRatingSearchDensityData> datas, Tyche tyche, Dictionary<int, int> modifiers = null)
    {
        int num = 0;
