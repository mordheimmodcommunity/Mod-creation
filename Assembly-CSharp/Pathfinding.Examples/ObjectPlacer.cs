...
namespace Pathfinding.Examples
{
	...
	public class ObjectPlacer : MonoBehaviour
	{
		...
		public void PlaceObject()
		{
			...
			GameObject gameObject = Object.Instantiate(go, point, Quaternion.identity) as GameObject;
			if (issueGUOs)
			{
		...
		{
			Ray ray = Camera.main.ScreenPointToRay(Input.mousePosition);
			if (!Physics.Raycast(ray, out RaycastHit hitInfo, float.PositiveInfinity) || hitInfo.collider.isTrigger || hitInfo.transform.gameObject.name == "Ground")
			{
				return;
			}
