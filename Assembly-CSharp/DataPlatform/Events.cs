...
namespace DataPlatform
{
	public class Events
	{
		...
		[Conditional("UNITY_XBOXONE")]
		public static void SendIncrementStat(string UserId, ref Guid PlayerSessionId, string StatId, int Increment)
		{
		}
		...
		[Conditional("UNITY_XBOXONE")]
		public static void SendUnlockAchievement(string UserId, ref Guid PlayerSessionId, string TrophyId)
		{
		}
