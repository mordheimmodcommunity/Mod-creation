...
public class WarbandContactItemQualityData : DataCore
{
	public int Id
	{
		get;
	...
	public static WarbandContactItemQualityData GetRandomRatio(List<WarbandContactItemQualityData> datas, Tyche tyche, Dictionary<int, int> modifiers = null)
	{
		int num = 0;
